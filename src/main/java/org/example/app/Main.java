...
import org.example.app.servises.ReadAlphabetService;
import org.example.app.servises.ReadAscService;
import org.example.app.servises.ReadDescService;
...
public class Main {
    ...
    public static int getOption() {
        ...
        System.out.print("""
                ...
                2 - View data in descending order.
                3 - View data in alphabetical order.
                0 - Close the app.
                """);
    ...
    private static void runOption(int option) {
        switch (option) {
            ...
            case 2 -> {
                ReadDescService service = new ReadDescService();
                getOutput(service.getData());
            }
            case 3 -> {
